...
static __initdata struct tegra_pingroup_config smba1007_pinmux[] = {
	...
	{TEGRA_PINGROUP_SDB,   TEGRA_MUX_PWM,           TEGRA_PUPD_PULL_UP,    TEGRA_TRI_TRISTATE},
	...
	{TEGRA_PINGROUP_SLXC,  TEGRA_MUX_SPDIF,         TEGRA_PUPD_PULL_UP,    TEGRA_TRI_NORMAL},
...
//	{ .gpio = SMBA1007_HDMI_ENB,			.enable = true },
  ...
  //{ .gpio = SMBA1007_SDIO2_CD,		.enable = true },
  //{ .gpio = SMBA1007_SDIO2_POWER,		.enable = true },
