...
static __initdata struct tegra_pingroup_config smba1007_pinmux[] = {
	...
	{TEGRA_PINGROUP_LCSN,  TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_PULL_UP,   TEGRA_TRI_TRISTATE},
        ...
        {TEGRA_PINGROUP_LDI,   TEGRA_MUX_SAFE,      TEGRA_PUPD_PULL_DOWN,    TEGRA_TRI_NORMAL},
        {TEGRA_PINGROUP_LHP0,  TEGRA_MUX_SAFE,      TEGRA_PUPD_PULL_DOWN,    TEGRA_TRI_NORMAL},
        {TEGRA_PINGROUP_LHP1,  TEGRA_MUX_SAFE,      TEGRA_PUPD_PULL_DOWN,    TEGRA_TRI_NORMAL},
        {TEGRA_PINGROUP_LHP2,  TEGRA_MUX_SAFE,      TEGRA_PUPD_PULL_DOWN,    TEGRA_TRI_NORMAL},
