...
static __initdata struct tegra_pingroup_config smba1007_pinmux[] = {
    ...
    {TEGRA_PINGROUP_CSUS,  TEGRA_MUX_PLLC_OUT1, 	TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
    ...
    {TEGRA_PINGROUP_LVP1,  TEGRA_MUX_RSVD1,      TEGRA_PUPD_PULL_DOWN,    TEGRA_TRI_NORMAL},
    ...
    {TEGRA_PINGROUP_SPDI,  TEGRA_MUX_SDIO2,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
    {TEGRA_PINGROUP_SPDO,  TEGRA_MUX_SDIO2,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
...
static __initdata struct tegra_drive_pingroup_config smba1007_drive_pinmux[] = {
#if 1
...
static struct tegra_gpio_table gpio_table[] = {
	{ .gpio = SMBA1007_BT_RESET,			.enable = true },
//	{ .gpio = SMBA1007_GPSMAG_DISABLE,	.enable = true },
	{ .gpio = SMBA1007_KEY_VOLUMEUP,		.enable = true },
	{ .gpio = SMBA1007_KEY_VOLUMEDOWN,	.enable = true },
	{ .gpio = SMBA1007_KEY_POWER,		.enable = true },
//	{ .gpio = SMBA1007_KEY_BACK,			.enable = true },
//	{ .gpio = SMBA1007_CAMERA_POWER,		.enable = true },
	{ .gpio = SMBA1007_NAND_WPN,			.enable = true },
	{ .gpio = SMBA1007_BL_ENB,			.enable = true },
	{ .gpio = SMBA1007_LVDS_SHUTDOWN,	.enable = true },
	{ .gpio = SMBA1007_EN_VDD_PANEL,		.enable = true },
	{ .gpio = SMBA1007_BL_VDD,			.enable = true },
	{ .gpio = SMBA1007_BL_PWM,			.enable = false }, /* We want the PWM function here! */
//	{ .gpio = SMBA1007_HDMI_ENB,			.enable = true },
	{ .gpio = SMBA1007_HDMI_HPD,			.enable = true },
	{ .gpio = SMBA1007_ENABLE_VDD_VID,	.enable = true },
	{ .gpio = SMBA1007_SDHC_CD,			.enable = true },
	{ .gpio = SMBA1007_SDHC_POWER,		.enable = true },
	{ .gpio = SMBA1007_TS_IRQ,			.enable = true },
	{ .gpio = SMBA1007_TS_POWER,		.enable = true },
	{ .gpio = SMBA1007_TS_RESET,		.enable = true },
	{ .gpio = SMBA1007_WLAN_POWER,		.enable = true },
	{ .gpio = SMBA1007_WLAN_RESET,		.enable = true },
	{ .gpio = SMBA1007_LOW_BATT,		.enable = true },
	{ .gpio = SMBA1007_IN_S3,			.enable = true },
	{ .gpio = SMBA1007_USB0_VBUS,		.enable = true },
	{ .gpio = SMBA1007_USB1_RESET,		.enable = true },

	{ .gpio = SMBA1007_HP_DETECT,		.enable = true },
};

void __init smba1007_pinmux_init(void)
{
	tegra_pinmux_config_table(smba1007_pinmux, ARRAY_SIZE(smba1007_pinmux));
	tegra_drive_pinmux_config_table(smba1007_drive_pinmux,
		ARRAY_SIZE(smba1007_drive_pinmux));
