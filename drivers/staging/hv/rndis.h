...
#define RNDIS_STATUS_INVALID_SAP		(0xC0010070L)
#define RNDIS_STATUS_SAP_IN_USE			(0xC0010071L)
#define RNDIS_STATUS_INVALID_ADDRESS		(0xC0010072L)
#define RNDIS_STATUS_VC_NOT_ACTIVATED		(0xC0010073L)
#define RNDIS_STATUS_DEST_OUT_OF_ORDER		(0xC0010074L)
#define RNDIS_STATUS_VC_NOT_AVAILABLE		(0xC0010075L)
#define RNDIS_STATUS_CELLRATE_NOT_AVAILABLE	(0xC0010076L)
#define RNDIS_STATUS_INCOMPATABLE_QOS		(0xC0010077L)
#define RNDIS_STATUS_AAL_PARAMS_UNSUPPORTED	(0xC0010078L)
#define RNDIS_STATUS_NO_ROUTE_TO_DESTINATION	(0xC0010079L)
