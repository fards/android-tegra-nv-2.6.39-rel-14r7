...
#define NDIS_STATUS_INVALID_SAP		((uint)0xC0010070L)
#define NDIS_STATUS_SAP_IN_USE		((uint)0xC0010071L)
#define NDIS_STATUS_INVALID_ADDRESS	((uint)0xC0010072L)
#define NDIS_STATUS_VC_NOT_ACTIVATED	((uint)0xC0010073L)
#define NDIS_STATUS_DEST_OUT_OF_ORDER	((uint)0xC0010074L) /* cause 27*/
#define NDIS_STATUS_VC_NOT_AVAILABLE	((uint)0xC0010075L) /* 35,45*/
#define NDIS_STATUS_CELLRATE_NOT_AVAILABLE ((uint)0xC0010076L) /* 37*/
#define NDIS_STATUS_INCOMPATABLE_QOS	((uint)0xC0010077L)  /* 49*/
#define NDIS_STATUS_AAL_PARAMS_UNSUPPORTED ((uint)0xC0010078L)  /*  93*/
#define NDIS_STATUS_NO_ROUTE_TO_DESTINATION ((uint)0xC0010079L)  /*  3*/
#define MPT_NOOP			0
