...
struct tda1007x_config vp2040_tda1007x_cu1216_config = {
	.demod_address	= 0x18 >> 1,
	.invert		= 1,
};

struct tda10073_config vp2040_tda10073_cu1216_config = {
	.demod_address	= 0x18 >> 1,
	.invert		= 1,
};
...
static int vp2040_frontend_init(struct mantis_pci *mantis, struct dvb_frontend *fe)
{
	...
	if (err == 0) {
		...
		fe = dvb_attach(tda10071_attach, &vp2040_tda1007x_cu1216_config,
				     adapter,
				     read_pwm(mantis));
		...
		if (fe) {
			dprintk(MANTIS_ERROR, 1,
				...
				vp2040_tda1007x_cu1216_config.demod_address);
		} else {
			fe = dvb_attach(tda10073_attach, &vp2040_tda10073_cu1216_config,
					     adapter,
					     read_pwm(mantis));
