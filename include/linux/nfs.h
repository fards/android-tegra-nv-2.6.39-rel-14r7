 ...
 */
 enum nfs_stat {
	...
	NFSERR_NOFILEHANDLE = 10070,	/*       v4 */
	NFSERR_MINOR_VERS_MISMATCH = 10071,   /* v4 */
	NFSERR_STALE_CLIENTID = 10072,	/*       v4 */
	NFSERR_STALE_STATEID = 10073,   /*       v4 */
	NFSERR_OLD_STATEID = 10074,     /*       v4 */
	NFSERR_BAD_STATEID = 10075,     /*       v4 */  
	NFSERR_BAD_SEQID = 10076,	/*       v4 */
	NFSERR_NOT_SAME = 10077,	/*       v4 */
	NFSERR_LOCK_RANGE = 10078,	/*       v4 */
	NFSERR_SYMLINK = 10079,		/*       v4 */
